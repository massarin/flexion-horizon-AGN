...
outdir="/net/GECO/nas12c/euclid/TestWorkFolder/lensing_maps/flexion_maps/G2"
...
for id in ids
    ...
    ofn = joinpath( outdir,
                    @sprintf("HAGN-G2-lightcone_%04d.fits",id) )
    ...
    if rf>1
	    ...
	    g2flexion = rebin(jac2G2(jac), factor=rf)
