...
outdir="/net/GECO/nas12c/euclid/TestWorkFolder/lensing_maps/flexion_maps/G1"
...
for id in ids
    ...
    ofn = joinpath( outdir,
                    @sprintf("HAGN-G1-lightcone_%04d.fits",id) )
    ...
    if rf>1
	    ...
	    g1flexion = rebin(jac2G1(jac), factor=rf)
