...
ρ_crit( c::Cosmology.AbstractCosmology, z::Real ) = 277.505425056 * (c.h*Cosmology.E(c,z))^2 #~10^9 h² Msun/kpc³ 
...
function dist_scaling( z::Real )
	...
	sigma_crit_inf = 1.6628140e12 * 1e6 / arcsec2kpc # Msun/kpc²
...
function ksrs2mc( ks::Real, rs::Real, q::Real ; Δ=:vir, runit=:kpc, z::Real=0.3 )
	...
	c = find_zero( x->δ_c(x)-dc, (1e-3,1e6), xatol=1e-3 )
