...
outdir="/net/GECO/nas12c/euclid/TestWorkFolder/lensing_maps/flexion_maps/F2"
...
for id in ids
    ...
    ofn = joinpath( outdir,
                    @sprintf("HAGN-F2-lightcone_%04d.fits",id) )
    ...
    if rf>1
	    ...
	    f2flexion = rebin(jac2F2(jac), factor=rf)
