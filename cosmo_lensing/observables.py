...
def flexion_F1(jac: np.ndarray) -> np.ndarray:
    ...
    logger.debug(
        f"Computed flexion F₁: min={F1.min():.3e}, "
        f"max={F1.max():.3e}, mean={F1.mean():.3e}"
    )
...
def flexion_F2(jac: np.ndarray) -> np.ndarray:
    ...
    logger.debug(
        f"Computed flexion F₂: min={F2.min():.3e}, "
        f"max={F2.max():.3e}, mean={F2.mean():.3e}"
    )
...
def flexion_G1(jac: np.ndarray) -> np.ndarray:
    ...
    logger.debug(
        f"Computed flexion G₁: min={G1.min():.3e}, "
        f"max={G1.max():.3e}, mean={G1.mean():.3e}"
    )
...
def flexion_G2(jac: np.ndarray) -> np.ndarray:
    ...
    logger.debug(
        f"Computed flexion G₂: min={G2.min():.3e}, "
        f"max={G2.max():.3e}, mean={G2.mean():.3e}"
    )
